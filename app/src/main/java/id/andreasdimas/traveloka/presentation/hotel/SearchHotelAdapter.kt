...
import id.andreasdimas.traveloka.databinding.ListItemLeagueBinding

/**
 * Created by Andreas Dimas Setyoko on 2021-03-15.
 */
class SearchHotelAdapter constructor(
    private val itemClick: (Entries?, pos: Int) -> Unit
) : ListAdapter<Entries, SearchHotelAdapter.ViewHolder>(DiffCallback()) {
    ...
    class ViewHolder(
        val binding: ListItemLeagueBinding
